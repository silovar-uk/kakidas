...
2. `RELEASE_NOTES_v0.5.34.md`〜`v0.5.39.md`：直近の事故対応と意図
...
> `README.md` はv0.5.32までの説明が中心で、v0.5.33〜v0.5.39の内容を十分に反映していない。最新の挙動は、該当するリリースノートと実装を正とする。
...
5. **READMEの更新遅れ**
   - v0.5.33〜v0.5.39の説明をREADMEにまだ統合していない。
