...
2. **本文優先、補助情報は静かに**
   ...
   - PCでは、備考＋とリンクを完了の右側へまとめる。項目タグの追加・変更・解除は、タグの有無にかかわらず同じ位置の小さなタグアイコンから行う。タグありは「気持ち・備考」と同じ補助行に表示専用の色付きチップとして置く。スマホではタグアイコンから下部シートを開く。
