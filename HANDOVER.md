...
2. `RELEASE_NOTES_v0.5.34.md`〜`v0.5.37.md`：直近の事故対応と意図
...
> `README.md` はv0.5.32までの説明が中心で、v0.5.33〜v0.5.37の内容を十分に反映していない。最新の挙動は、該当するリリースノートと実装を正とする。
...
- タイトルに合わせてブラウザタブ名を更新
- 単語・文・段落の追加・編集・削除
- Word / Sentenceの親子関係、右へ下げる・左へ戻す・並べ替え
- 満足度、完了、備考、リンク
...
5. **READMEの更新遅れ**
   - v0.5.33〜v0.5.37の説明をREADMEにまだ統合していない。
