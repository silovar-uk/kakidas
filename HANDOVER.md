...
- `EntryComposer`では、新しい項目を置く前に任意の項目タグを選べる。タグは本文と同時に保存し、保存後は次の入力へ持ち越さない。
...
- [ ] 新規の単語・文・段落で、本文と同時にタグを選んで保存でき、保存後にタグが持ち越されないことを確認する
